...
def main(repo_dispatch_key):
    ...
    github_dispatch = requests.post('https://api.github.com/repos/DamovisaOrg/azureml-v2-preview/dispatches', data={'event_type':'model_registered', 'client_payload': {'name': saved_model.name, 'version': saved_model.version, 'url': saved_model.url }}) 
